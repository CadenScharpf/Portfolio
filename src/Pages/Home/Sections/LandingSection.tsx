    ...
    return (
        <div style={{ display: 'flex', width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center', }}>
            <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left', marginLeft: '10%', marginTop: '10%', width: '25%'/* , paddingBottom: '15%' */ }}>
                <motion.h1 style={{ fontSize: '4rem', margin: 0, padding: 0, color: '#000' }} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: getPhaseDelay(0), duration: PHASE_ANIMATION_DURATION }}>
                    Caden<br/> Scharpf
                </motion.h1>
                <motion.h2
                ...
                <motion.p initial={{opacity: 0}} animate={{opacity: 1}} transition={{delay: getPhaseDelay(2), duration: PHASE_ANIMATION_DURATION}} style={{color: '#000', textAlign: 'left'}}>
            ...
            <div style={{ width: '75%', height: '100%', display: 'flex', alignItems: 'center', marginLeft: 200 /* paddingBottom: '15%' */ }}>
